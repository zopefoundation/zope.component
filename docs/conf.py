#
# zope.component documentation build configuration file, created by
...
latex_documents = [
    ('index', 'zopecomponent.tex', 'zope.component Documentation',
...
man_pages = [('index', 'zopecomponent', 'zope.component Documentation',
...
texinfo_documents = [
    ('index', 'zopecomponent', 'zope.component Documentation',
